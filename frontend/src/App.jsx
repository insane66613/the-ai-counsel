              ...
              setCurrentConversation((prev) => {
                ...
                const updatedLastMsg = {
                  ...
                  metadata: {
                    ...
                    convergence_status: event.convergence_status || lastMsg.metadata?.convergence_status,
                    pipeline_warnings: event.warnings || lastMsg.metadata?.pipeline_warnings,
                    pipeline_error: event.error || lastMsg.metadata?.pipeline_error,
                    claim_audit_status: lastRound.metadata?.claim_audit_status || lastMsg.metadata?.claim_audit_status,
